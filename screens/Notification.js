...
import { Container, Content, Header, Right, Text, Thumbnail, View } from 'native-base'
        ...
        return (
            <View>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <Thumbnail circular small source={{ uri: item.pic }} style={{ padding: 5, margin: 5, marginBottom: 0 }} />
                    <Text numberOfLines={2} style={{ marginHorizontal: 5, textAlignVertical: 'center' }}>{item.title}</Text>
                    <Right>
                        <Thumbnail circular small source={{ uri: item.follower_pic }} style={{ padding: 5, margin: 5, marginBottom: 0, alignContent: 'flex-end' }} />
                    </Right>
                </View>
            </View>
        )
...
export default function Notifications() {
    ...
    return (
        ...
        <Container>
            <Header style={{ alignContent: 'flex-start', backgroundColor: 'white', justifyContent: 'flex-start' }} >
            ...
            <Content>
                <View style={{ flex: 1, flexDirection: 'row' }}>
                    <Ionicons name="person-add-outline" size={24} color="black" style={{ borderBottomColor: 'black', borderWidth: 1, borderRadius: 60, padding: 5, margin: 5 }} />
